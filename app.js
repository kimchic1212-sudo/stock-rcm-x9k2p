...
window.openAnalyticsReport = async () => {
    ...
    const renderDashUI = () => {
        ...
        modal.innerHTML = `
            ...
            <main class="flex-1 overflow-hidden p-3 flex flex-col gap-3 min-h-0">
                <div class="max-w-[1400px] mx-auto w-full flex flex-col h-full gap-3 min-h-0">
                    ...
                    <section class="flex flex-col bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex-1 min-h-0">
                        ...
                        <div id="dashListBody" class="flex-1 overflow-y-auto dash-scroll px-3 py-1"></div>
                    </section>
                </div>
            </main>
        `;
